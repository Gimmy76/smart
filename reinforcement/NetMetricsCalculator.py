...
if __name__ == "__main__":
    ...
    parser.add_argument("-aux", "--auxiliary-file", help="Whether to use testing file or not")
    ...
    tmp_dir = f'{current_path}/tmp'
    pcap_file = f'{tmp_dir}/tshark_out.pcap'
    metrics_file = f'{tmp_dir}/metrics.json'
    if config['auxiliary_file']:
        pcap_file = config['auxiliary_file']
