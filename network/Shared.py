    ...
    def __init__(self, config):
        ...
        if 'num_controlled_switches' in config and config['num_controlled_switches'] is not None:
            ...
            if num_switches % 4 == 0:
                ...
                print(f"Warning: Number of controlled switches must be a multiple of 4. Using default value 4.")
