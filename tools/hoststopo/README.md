...
## Run arguments:
- `-s101`: Number of hosts connected to switch `s101`.
- `-s102`: Number of hosts connected to switch `s102`.
- `-s103`: Number of hosts connected to switch `s103`.
- `-s104`: Number of hosts connected to switch `s104`.
...
- Supported controlled switches: The current version of the script supports only the following controlled switches: `[s101, s102, s103, s104]`
...
```shell
sudo python3 HostsTopoGenerator.py -s101 20 -s102 30 -s103 10 -s104 10
```
...
Go to `tools/hoststopo` directory and execute:
```shell
sudo python3 HostsTopoGenerator.py -s101 20 -s102 30 -s103 10 -s104 10 -f test
```
...
Go to `tools/hoststopo` directory and execute:
```shell
sudo python3 HostsTopoGenerator.py -s101 20 -s102 30 -s103 10 -s104 10 -f test --force
```